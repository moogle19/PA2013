...
public class OpenCL 
{
    ...
    public static void clReleaseEvent(CLEvent event)
    {
        checkError(CL10.clReleaseEvent(event));
    }

    public static void clWaitForEvents(PointerBuffer event)
    {
        checkError(CL10.clWaitForEvents(event));
    }
    
    public static void clGetEventProfilingInfo(CLEvent clEvent, int param, ByteBuffer value)
    {
        checkError(CL10.clGetEventProfilingInfo(clEvent, param, value, null));
    }
    
    public static void clGetEventProfilingInfo(CLEvent clEvent, int param, ByteBuffer value, PointerBuffer argSize_ret)
    {
        checkError(CL10.clGetEventProfilingInfo(clEvent, param, value, argSize_ret));
    }
     ...
     */
    public static void clSetKernelArg(CLKernel kernel, int arg_index, float arg_value) 
    {
        BufferHelper.FLOAT.put(0, arg_value);
     ...
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clSetKernelArg.html">clSetKernelArg</a>
     */
    public static void clSetKernelArg(CLKernel kernel, int arg_index, int arg_value) 
    {
        BufferHelper.INT.put(0, arg_value);
     ...
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clSetKernelArg.html">clSetKernelArg</a>
     */
    public static void clSetKernelArg(CLKernel kernel, int arg_index, LongBuffer arg_value) 
    {
     ...
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clSetKernelArg.html">clSetKernelArg</a>
     */
    public static void clSetKernelArg(CLKernel kernel, int arg_index, short arg_value) 
    {
        BufferHelper.SHORT.put(0, arg_value);
     ...
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clSetKernelArg.html">clSetKernelArg</a>
     */
    public static void clSetKernelArg(CLKernel kernel, int arg_index, byte arg_value) 
    {
        BufferHelper.BYTE.put(0, arg_value);
     ...
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clSetKernelArg.html">clSetKernelArg</a>
     */
    public static void clSetKernelArg(CLKernel kernel, int arg_index, long localMemorySizeInBytes) 
    {
        checkError(CL10.clSetKernelArg(kernel, arg_index, localMemorySizeInBytes));
    }
