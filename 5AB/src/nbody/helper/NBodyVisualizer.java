...
public class NBodyVisualizer extends FrameWork 
{    
    ...
    private int m_invCameraAdress;
    
    private Geometry[] m_buffer = new Geometry[2];
    
    private Program m_program;
    
    private int m_toggle = 0;
    
    private CLMem m_oglBuffer0;
    private CLMem m_oglBuffer1;
    
    public NBodyVisualizer(int w, int h) 
    {
        super(w, h, true, true, "N-Body Simulation");
    }
    ...
    public CLMem[] createPositions(float[] pos, CLContext context)
    {
        ...
        m_oglBuffer0 = clCreateFromGLBuffer(context, CL_MEM_READ_WRITE, m_buffer[0].getInstanceBuffer().getId());
        m_oglBuffer1 = clCreateFromGLBuffer(context, CL_MEM_READ_WRITE, m_buffer[1].getInstanceBuffer().getId());
